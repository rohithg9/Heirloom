        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="text-center">
              <button 
                className="w-full md:w-auto bg-gradient-to-r from-sage to-sage-dark hover:from-sage-dark hover:to-sage text-white text-base md:text-lg px-6 md:px-8 py-4 md:py-5 rounded-xl shadow-lg flex items-center justify-center gap-2 mx-auto font-medium"
